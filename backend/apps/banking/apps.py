...
dependency graph and every ``"banking.Model"`` string reference in the project.
...
class BankingConfig(AppConfig):
    """Bank accounts, imported statements and reconciliation.
    """
