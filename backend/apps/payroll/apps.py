...
dependency graph and every ``"payroll.Model"`` string reference in the project.
...
class PayrollConfig(AppConfig):
    """Payroll runs, payslips, statutory contributions and bank files.
    """
