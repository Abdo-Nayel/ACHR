...
dependency graph and every ``"inventory.Model"`` string reference in the project.
...
class InventoryConfig(AppConfig):
    """Items, warehouses, stock levels, movements and valuation.
    """
